 ...
 */
public class SampleConfiguration extends javax.security.auth.login.Configuration {
     ...
     */
    public SampleConfiguration(URI uri) {
    ...
    public SampleConfiguration(
    		HashMap<String, LinkedList<AppConfigurationEntry>> initConfig) {
    	configuration = 
    		new HashMap<String, LinkedList<AppConfigurationEntry>>(initConfig);
    }
    ...
    public HashMap<String, LinkedList<AppConfigurationEntry>> getConfMap() {
		return configuration;
	}

	public void setConfMap(
			HashMap<String, LinkedList<AppConfigurationEntry>> configuration) {
